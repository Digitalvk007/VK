...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/shrill-poetry-c53b)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/shrill-poetry-c53b
```

A live public deployment of this template is available at [https://shrill-poetry-c53b.templates.workers.dev](https://shrill-poetry-c53b.templates.workers.dev)
